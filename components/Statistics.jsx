...
const Statistics = () => {
  return (
    <>
      <div className="pt-[90px] pb-[76px] px-[50px] relative">
        ...
        <div className="flex flex-row-reverse justify-between">
          <div className="flex items-center">
            <div className="flex flex-col items-end pr-3">
              ...
              <span className="text-[16px] text-[#454849] font-iranYekan leading-[34px]">فارغ التحصیل مشغول به کار</span>
            </div>
            <div className="bg-gradient-[134deg] from-[#E6EAED] to-[#8094A6] relative rounded-[10px] bg-origin-padding bg-no-repeat flex justify-center items-center w-[60px] h-[60px]">
              ...
              <Image src="/assets/images/student.png" width={31} height={28} />
            </div>
          </div>
          <div className="flex items-center">
            <div className="flex flex-col items-end pr-3">
              <span className="text-[#CC6123] text-[30px]">1000</span>
              <span className="text-[16px] text-[#454849] font-iranYekan leading-[34px]">ساعت دوره آموزشی حضوری</span>
            </div>
            ...
            <div className="bg-[#FFE4D5] absolute w-[44px] h-[44px] blur-[10px] bottom-0"></div>
              ...
              <Image src="/assets/images/clock.png" width={30} height={30} />
            </div>
          </div>
          <div className="flex items-center">
            <div className="flex flex-col items-end pr-3">
              <span className="text-[#3086A6] text-[30px]">10</span>
              <span className="text-[16px] text-[#454849] font-iranYekan leading-[34px]">استاد برجسته و ماهر</span>
            </div>
            ...
            <div className="bg-[#DAF2FB] absolute w-[36px] h-[36px] blur-[10px] bottom-0"></div>
              ...
              <Image src="/assets/images/teacher.png" width={30} height={33} />
            </div>
          </div>
          <div className="flex items-center">
            <div className="flex flex-col items-end pr-3">
              <span className="text-[#4D5051] text-[30px]">6</span>
              <span className="text-[16px] text-[#454849] font-iranYekan leading-[34px]">دوره پرطرفدار و به روز</span>
            </div>
            ...
            <div className="bg-[#DBDCDC] absolute w-[36px] h-[36px] blur-[10px] bottom-0"></div>
              ...
              <Image src="/assets/images/course.png" width={30} height={28} />
            </div>
          </div>
        </div>
      </div>
