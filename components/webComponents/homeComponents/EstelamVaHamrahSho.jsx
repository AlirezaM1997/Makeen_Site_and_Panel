...
const EstelamVaHamrahsho = () => {
  return (
    <>
      <section className="flex flex-row-reverse justify-evenly mb-[85px] font-iranYekan">
        <div className="bg-[#def4fc] w-[645px] relative rounded-[20px] h-[250px]">
          ...
          <Image
            ...
            layout="fill"
          />
          <h1 className="w-fit font-extrabold text-[24px] text-[#00213E] absolute top-[20px] right-[80px] "></h1>
          <h1 className=" w-fit font-extrabold text-[24px] text-[#00213E] absolute top-[20px] right-[80px] ">
            استعلام دانشجویان مکین
          </h1>
          <div className="w-[383px] absolute top-[70px] right-[80px]">
            <p className="w-fit text-right text-[#4D6982] text-[16px] ">
              برای استعلام از دانشجویان مکین کد گواهی دانشجویان را در کادر زیر
              وارد کنید
            </p>
          </div>
          <div className="flex justify-between w-[480px] absolute bottom-[35px] right-[80px]">
            <button className="p-[10px] text-[#ECF9FD] w-[70px] hover:-translate-y-2 duration-150 text-[12px] text-center bg-[#FF8641] rounded-[10px] ">
              تایید
            </button>
            <input
              type="number"
