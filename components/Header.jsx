...
const Header = () => {
  return (
    <>
      <div className="relative h-[100px] w-full flex justify-center px-[48px] pt-[29px]  bg-white backdrop-blur-[40px] backdrop-brightness-[50] backdrop-opacity-70">
        ...
        {/* </div> */}
        <div className="w-full absolute top-0 left-0 h-[30px] bg-gradient-[271deg] from-[#37BBEC] to-[#FF792C] bg-origin-padding blur-[30px] bg-no-repeat opacity-30"></div>
      </div>
    </>
  );
};
