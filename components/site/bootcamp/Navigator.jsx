export default function Navigator() {
  ...
  return (
    <>
      <div
        dir="rtl"
        className="w-[211px] h-[255px] pr-[20px] pt-[35px] mr-[30px] mt-[170px] z-40 bg-[#FFFFFF] rounded-[10px] sticky top-[310px] left-[1200px] border-[#CACBCB] border-[0.5px] text-[#4D6982] "
      >
