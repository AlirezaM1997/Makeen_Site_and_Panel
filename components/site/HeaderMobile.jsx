...
export default function HeaderMobile() {
  return (
    <>
      <header className="h-[46px] z-[1002] fixed overflow-hidden flex xl:hidden items-center justify-between top-0 w-full py-[11px] px-5 border-[1px] border-[#FFFFFF] bg-white">
