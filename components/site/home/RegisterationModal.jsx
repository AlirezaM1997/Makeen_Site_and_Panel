...
export default function RegisterationModal() {
  ...
  return (
    <>
      <div
        className={`${
          modalMode ? "block opacity-100" : "-top-full opacity-0"
        } fixed w-full h-full top-0 left-0 z-[1001] p-[48px] bg-[#4d698266] backdrop-blur-[10px] transition-topOpacity duration-500`}
