export const PrevArrow=({ prevSlide })=> {
  return (
    <div className="arrows flex relative">
      <span
        className="prev group flex justify-center items-center cursor-pointer shadow-[-3px_10px_20px_#00000029] w-[35px] h-[35px] bg-white rounded-full absolute"
        onClick={prevSlide}
      >
        ...
        <div className="absolute scale-0 transition duration-300 ease-in-out group-hover:scale-100 bg-[#00294D] w-[35px] h-[35px] rounded-full"></div>
      </span>
    </div>
  );
}
export const NextArrow=({nextSlide}) =>{
  return(
    <div className="arrows flex relative">
      <span
        className="next group flex justify-center items-center cursor-pointer shadow-[-3px_10px_20px_#00000029] w-[35px] h-[35px] bg-white rounded-full absolute"
        onClick={nextSlide}
      >
        <div className="relative w-5 h-4">
          <svg
          ...
          <div className="absolute -top-[55%] -right-[7px] scale-0 transition duration-300 ease-in-out group-hover:scale-100 bg-[#00294D] w-[35px] h-[35px] rounded-full"></div>
        </div>
      </span>
    </div>
  )
